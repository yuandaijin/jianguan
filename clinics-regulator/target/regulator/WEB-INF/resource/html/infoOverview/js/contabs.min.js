...
function simulateNavClickAddTabsClickFn(element) {
	$(element).click(fn);
}
...
*/
// 模拟菜单按钮点击事件打开标签页
function simulateNavClickAddTabs(iframeURL) {
	var li, a;
	console.log($(".J_menuTab[detailtab='" +iframeURL+ "']").length == 1)
	if($(".J_menuTab[detailtab='" +iframeURL+ "']").length==1) {
		console.log('1')
		a = $(".mytabsbtn[detailtab='" +iframeURL+ "']");
		li = $(a).parent();
	} else {
		console.log('0')
		li = $("<li class='mytabsbtn-wrap'>");
		a = $("<a class='mytabsbtn' style='display: none;' data-index='" + iframeURL+ "'>");
		a.attr("detailtab", iframeURL);
		a.appendTo(li);
		li.appendTo($("#side-menu").find(".active").find("ul"));
	}

    
    simulateNavClickAddTabsClickFn(a);
    //创建事件对象
    ...
    $(".active.J_menuTab").attr("detailtab", iframeURL);
}


//$("iframe[name='iframe" + iframeURL + "']").document
//
////测试代码：
//var div = $("<div>").css({
//	background: 'red',
...
//console.log($(window.frames[0].document.body).append(div))
//
//div.click(function() {
//	simulateNavClickAddTabs('/operate/orderSelect');
//});